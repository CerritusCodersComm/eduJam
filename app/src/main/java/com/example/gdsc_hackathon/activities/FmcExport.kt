...
class FmcExport : AppCompatActivity() {
        ...
        PdfGenerator.getBuilder()
            ...
            .build(object : PdfGeneratorListener() {
                override fun onFailure(failureResponse: FailureResponse) {
                    ...
                    Log.d("FMC EXPORTING", "Pdf creation failed")
                    showSnackBar(activity, "$failureResponse")
                }

                override fun onStartPDFGeneration() {
                    Log.d("FMC EXPORTING", "Pdf creation started")
    ...
    private fun showAlertDialogButtonClicked() {
        ...
        builder.setTitle(getString(R.string.fmc_file_path_dialog_title))

        val customLayout: View = layoutInflater
            .inflate(
                R.layout.custom_edit_text_dialog,
                null
            )
        ...
        dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener {
            ...
            val edtTextLayout: TextInputLayout = customLayout.findViewById(R.id.dialog_EditTextLayout)
            val editText: EditText = customLayout.findViewById( R.id.dialog_EditText )
            fileName = editText.text.toString()

            if(fileName.isEmpty())
                edtTextLayout.error = "This Field is required"
