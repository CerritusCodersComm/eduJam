    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dopdoc.setOnClickListener{
            ...
            exported.setOnClickListener{
                noexp = Integer.parseInt(noval.text.toString())
                val marks1=exp_1_input.text.toString()
                val marks2=exp_2_input.text.toString()
                val marks3=exp_3_input.text.toString()
                val marks4=exp_4_input.text.toString()
                val marks5=exp_5_input.text.toString()
                val marks6=exp_6_input.text.toString()
                val marks7=exp_7_input.text.toString()
                val marks8=exp_8_input.text.toString()
                val marks9=exp_9_input.text.toString()
                val marks10=exp_10_input.text.toString()
                val marks11=exp_11_input.text.toString()
                val marks12=exp_12_input.text.toString()
                val famarks1 =fm1.text.toString()
                val famarks2=fm2.text.toString()
                val famarks3=fm3.text.toString()
